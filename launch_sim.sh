...
gnome-terminal --window \
	...
	\
 	...
 	--command="bash -c 'cd \"$HOME/ardupilot/\"&& ./waf configure --board sitl &&./waf plane && sim_vehicle.py -v ArduPlane --model JSON --add-param-file=$HOME/SITL_Models/Gazebo/config/swan_k1_hwing.param --console --map; exec bash'"
